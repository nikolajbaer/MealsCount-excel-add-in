...
function refreshData() {
    ...
    function enrichSchoolInfo(schoolInfo, state) {
        ...
        // Translate schoolInfo into array that can be used to populate worksheet
    ...
    fetch(url)
        ...
        .then(enrichedData => {
            Excel.run(context => {
                ...
                // Define what data should go in proxy objects
                range.values = formatOptimalSolution(enrichedData);
                range2.values = "Hello World";
